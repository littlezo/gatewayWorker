...
use \app\socket\ServiceDispatch;
use \app\service\v1\GroupService;
            ...
            switch ($event) {
                case 'bind': // 登陆
                    if ($data['uid']) { // 绑定及加入群组
                        ...
                        Gateway::joinGroup($client_id, 'GLOBAL'); // 用于推送全员消息  例如：公告
                        // 获取用户业务组
